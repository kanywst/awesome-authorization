...
- [AuthZEN Specification](https://openid.net/wg/authzen/) - OpenID standard for a REST API for authorization decisions (PDP/PEP), approved as a [Final Specification](https://openid.net/authorization-api-1-0-final-specification-approved/) on 2026-01-12.
...
- [Oso](https://www.osohq.com/oso-for-apps) - Managed authorization using the Polar policy language.
...
- [WorkOS FGA](https://workos.com/docs/fga) - Fine-grained authorization built on the Warrant engine.
...
- [BSides Basingstoke - IAM Very Confused (2025)](https://tomcope.com/talk/2025-06-25-bsides-basingstoke-2025/) - Beginner-friendly tour of modern IAM and authz concepts, with video and slides.
